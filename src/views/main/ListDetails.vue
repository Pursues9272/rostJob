        ...
        <div class="row-left">
          <el-row :gutter="20">
            <el-col :span="9"><div class="grid-content ep-bg-purple" >
              <img style="border:1px solid #ddd;width:100%"  :src="details.articleCover" alt="">
            </div>
            </el-col>
            <el-col :span="15"><div class="grid-content ep-bg-purple">
              ...
              <div class="details">
                ...
                <div class="details-right">￥ <span class="text-style">{{details.articlePrice}}</span></div>
              </div>
              <div class="details">
                <div class="details-left">特格</div>
                <div class="details-right">￥ <span style="font-size:16px;color:red;">{{details.articleDiscount}}</span></div>
              </div>
              <div class="details">
              ...
              <div class="details">
                ...
                <div class="details-right">
                  <el-input-number v-model="detailsNum" :min="1" :max="10" @change="handleChange" />
                </div>
              </div>
              <div class="details" >
                <el-button size="large" type="primary" @click="addGw()">加入购物车</el-button>
              </div>
            </div></el-col>
          </el-row>
          <h5>
...
export default {
  ...
  data() {
    return {
      title:this.$route.query.type==1?'约稿':this.$route.query.type==2?'制品':'官方周边',
      details:'',
      detailsNum:1,
